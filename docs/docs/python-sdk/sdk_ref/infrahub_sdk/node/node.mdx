...
```python
delete(self, timeout: int | None = None, request_context: RequestContext | None = None, priority: Priority | None = None) -> None
```
...
- `priority`: Per-request priority emitted as the X-Priority header,
overriding the client default for this request only.

#### `save`

```python
save(self, allow_upsert: bool = False, update_group_context: bool | None = None, timeout: int | None = None, request_context: RequestContext | None = None, priority: Priority | None = None) -> None
```
...
```python
create(self, allow_upsert: bool = False, timeout: int | None = None, request_context: RequestContext | None = None, priority: Priority | None = None) -> None
```
...
```python
update(self, do_full_update: bool = False, timeout: int | None = None, request_context: RequestContext | None = None, priority: Priority | None = None) -> None
```
